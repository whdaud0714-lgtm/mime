	...
	return (
		<footer className="mt-24 border-t border-ink/10 bg-card">
			<div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-[1.4fr_1fr_1fr]">
				...
				<div className="text-sm">
					...
					<ul className="mt-3 space-y-2 text-ink/70">
						...
						<li>
							<Link href="/program" className="hover:text-amber">
								프로그램
							</Link>
						</li>
						<li>
							<Link href="/visit" className="hover:text-amber">
								방문 안내
							</Link>
						</li>
						<li>
							<Link href="/brand" className="hover:text-amber">
								브랜드 전략·가이드
							</Link>
						</li>
						<li>
							<Link href="/bookmark" className="hover:text-amber">
								북마크 · 공유
							</Link>
						</li>
						<li>
							<Link href="/app" className="hover:text-amber">
								모바일 앱
							</Link>
						</li>
					</ul>
			...
			<div className="border-t border-ink/10 px-5 py-5 text-center text-xs leading-relaxed text-ink/40">
				© 2026 {festival.hostKo} · Chuncheon International Mime
				Festival.
				<br />본 사이트는 홍보 기획 프로젝트 산출물이며 일부
				정보(주최·후원·티켓·연혁)는 예시입니다. 사진·포스터 이미지의
				저작권은 춘천마임축제에 있습니다.
			</div>
		</footer>
	);
