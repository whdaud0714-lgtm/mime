...
export const festival = {
  ...
  venues: [
    { ko: "축제극장 몸짓", en: "Momjit Festival Theatre", role: "메인 공연장 · 야외광장" },
    { ko: "춘천 중앙로", en: "Jungang-ro, Downtown", role: "개막난장 ‘아!水라장’" },
    { ko: "레고랜드 코리아 리조트 주차장", en: "Legoland Korea Resort", role: "밤샘난장 ‘도깨비난장’" },
    { ko: "브라운5번가", en: "Brown 5th Ave.", role: "거리극·난장" },
    { ko: "공지천 유원지", en: "Gongjicheon Riverside", role: "가족 프로그램" },
...
export const programs: Program[] = [
  {
    ...
    blurbKo: "물총과 물대포가 오가는 도심 개막 난장. 컬러 슈트를 입은 배우들의 군무로 8일간의 축제가 시작된다.",
    photo: "waterOpening",
  },
  {
    slug: "mad-friday",
    ...
    where: "브라운5번가 · 도심 일대",
    blurbKo: "밤새 이어지는 춘천마임축제의 상징. 우비를 입은 관객과 배우가 뒤엉켜 거리를 무대로 만든다.",
    photo: "streetWater",
  },
  {
    slug: "goblin",
    ...
    blurbKo: "불과 어둠, 화염 퍼포먼스와 함께 해 뜰 때까지 이어지는 폐막 밤샘 난장. 관객 모두가 무대에 오른다.",
    photo: "goblinFire",
  },
  {
    slug: "world-mime",
    ...
    when: "5. 26.(화)–5. 30.(토)",
    where: "축제극장 몸짓 · 남이섬",
    blurbKo: "프랑스·독일·일본·체코 등 해외 극단이 참여하는 국제 초청 무대. 언어 없이 통하는 밤.",
  },
  {
    slug: "hada",
    nameKo: "하다마당",
    ...
    where: "축제극장 몸짓",
    blurbKo: "국내 마임·피지컬시어터 대표 레퍼토리를 매일 만나는 메인 프로그램.",
  },
  {
    slug: "street",
    nameKo: "아수라장 거리극",
    ...
    where: "브라운5번가 · 공지천",
    blurbKo: "예고 없이 나타나는 거리 공연. 골목을 돌면 새로운 장면이 기다린다.",
  },
  {
    slug: "kids",
    nameKo: "몸짓놀이터",
  ...
  },
  {
    ...
    where: "축제극장 몸짓 야외광장",
    blurbKo: "축제가 없는 계절에도 몸짓은 계속된다. 가을밤, 동네 광장에서 열리는 상설 마임 살롱.",
    photo: "salon",
  },
];
