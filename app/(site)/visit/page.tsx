...
const TRANSPORT = [
	{
		m: "ITX-청춘 / 경춘선",
		d: "서울 용산·청량리 → 춘천역 약 70분. 축제 기간 임시 증편 운행.",
	},
	{ m: "고속·시외버스", d: "서울(동서울) → 춘천 약 70분. 10~20분 간격." },
	{
		m: "자가용",
		d: "서울양양고속도로 → 남춘천 IC. 축제장 인근 공영주차장 이용(혼잡, 대중교통 권장).",
	},
	{
		m: "축제 셔틀",
		d: "춘천역·시외버스터미널 ↔ 주요 축제장 무료 순환 셔틀(10분 간격).",
	},
];
		...
		<>
				...
				<Container>
					...
					<ul className="mt-10 grid gap-5 md:grid-cols-2">
						{TRANSPORT.map((x) => (
							<li
								key={x.m}
								className="reveal rounded-xl border border-ink/12 bg-base p-5"
							>
							...
							<tbody>
								{TICKETS.map((t) => (
									...
									>
										...
										<td className="py-3.5 pr-4 text-amber">
											{t.p}
										</td>
										<td className="py-3.5 text-ink/65">
											{t.n}
										</td>
									</tr>
								))}
			...
			<section className="border-t border-ink/10 py-16">
				<Container className="grid gap-8 md:grid-cols-2">
					<div>
						<h3 className="font-display text-lg text-amber">
							문의
						</h3>
					...
					<div>
						...
						<p className="mt-3 text-sm text-ink/70">
							명동·석사동 일대 호텔·게스트하우스 도보 15분 내.
							축제 기간 조기 마감되니 미리 예약하세요.
						</p>
					</div>
				</Container>
			</section>
