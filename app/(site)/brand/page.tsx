...
const CROSS = [
	[
		"SO 공격",
		"무언 퍼포먼스의 숏폼 확산력 + 외국인 관객 증가를 결합 → ‘번역이 필요 없는 축제’로 글로벌 포지셔닝.",
	],
	[
		"ST 방어",
		"역사·대표 IP를 앞세워 ‘5월엔 춘천마임’이라는 시즌 고정 연상 구축, 경쟁 축제와 차별화.",
	],
	[
		"WO 만회",
		"상시 북마크 링크(웹·PWA)로 디지털 접점을 확보해 홍보 채널 열세를 유저 확산으로 상쇄.",
	],
	[
		"WT 최소화",
		"무료 거리 프로그램·실내 대안 편성으로 진입장벽과 기상 리스크를 동시에 완화.",
	],
];
...
const REACH = [
	[
		"1단계 · 춘천 시민",
		"‘우리 도시의 자부심’ — 자원활동·지역 상권 연계로 팬층 결속.",
	],
	[
		"2단계 · 대한민국 국민",
		"‘5월의 국가대표 몸짓 축제’ — 북마크·공유 캠페인으로 전국 인지 확산.",
	],
	[
		"3단계 · 세계인",
		"‘언어가 필요 없는 축제’ — 다국어 링크·외국인 후기로 방한 관광 연결.",
	],
];
...
const COLORS = [
	{
		hex: "#f4eee1",
		name: "Paper Base",
		use: "기본 배경 · 마임 분장의 종이빛. 전체 화면의 기준색.",
	},
	{
		hex: "#fcf9f1",
		name: "Card",
		use: "카드·패널. 배경보다 한 톤 밝게 띄워 정보를 얹는 면.",
	},
	{
		hex: "#1c1712",
		name: "Ink",
		use: "본문 텍스트 · 강조색 위 글자 · 무대의 그림자.",
	},
	{
		hex: "#a56300",
		name: "Spotlight Amber",
		use: "핵심 강조 · CTA · 링크. 밝은 배경에서도 읽히는 조명색.",
	},
	{
		hex: "#196380",
		name: "Lake Blue",
		use: "보조색 · 춘천 호수. 정보·차분한 면.",
	},
	{
		hex: "#c9333a",
		name: "Signal Coral",
		use: "포인트 · 태그·에너지. 몸짓의 생동.",
	},
];
				...
				<Container>
					...
					<div className="mt-5 grid gap-4 sm:grid-cols-2">
						{CROSS.map(([t, d]) => (
							<div
								key={t}
								className="rounded-xl border border-ink/12 bg-base p-5"
							>
					...
					<div className="mt-10 grid gap-6 lg:grid-cols-2">
						<div className="rounded-2xl border border-ink/12 bg-base p-7">
							...
							<ul className="mt-4 space-y-3 text-sm text-ink/75">
								<li>
									<b className="text-ink">정성</b> · ‘춘천 =
									마임’, ‘마임 = 언어가 필요 없는 축제’ 연상
									확립
								</li>
								<li>
									<b className="text-ink">정량</b> · 북마크
									링크 저장 10만 · 공유 5만 · PWA 설치 2만
									(캠페인 기간)
								</li>
								<li>
									<b className="text-ink">전환</b> · 온라인
									관심 → 유료 예매·현장 방문·외국인 관객 비중
									확대
								</li>
								<li>
									<b className="text-ink">지속</b> · 축제 종료
									후에도 유지되는 상시 팬 채널(재방문·차년도
									알림)
								</li>
							</ul>
						</div>
				...
				<Container>
					...
					<div className="mt-10 rounded-2xl border border-amber/40 bg-[radial-gradient(ellipse_at_top_left,rgba(255,182,39,0.12),transparent_60%)] p-8">
						...
						<p className="mt-3 max-w-2xl text-sm text-ink/70">
							마임의 본질(말 없이 통함)을 곧 축제의 세계화 논리로
							삼는다. 자막도 번역도 필요 없기에, 이 축제는
							처음부터 세계인의 것이 될 수 있다.
						</p>
					...
					<div className="mt-8 grid gap-6 lg:grid-cols-2">
						<div className="rounded-2xl border border-ink/12 bg-card p-7">
							...
							<ul className="mt-4 space-y-3 text-sm text-ink/75">
								<li>
									<b className="text-ink">메인(국문)</b> · “
									{festival.sloganKo}”
								</li>
								<li>
									<b className="text-ink">메인(영문)</b> · “
									{festival.sloganEn}.”
								</li>
								<li>
									<b className="text-ink">서브</b> · “
									{festival.taglineKo}”
								</li>
								<li>
									<b className="text-ink">캠페인</b> · “북마크
									한 번, 세계인의 축제로.”
								</li>
							</ul>
						</div>
					...
					<div className="mt-8 rounded-2xl border border-ink/12 bg-base p-7">
						<h3 className="font-bold text-amber">
							표현전략 (Visual Principles)
						</h3>
						<ul className="mt-4 grid gap-3 text-sm text-ink/75 sm:grid-cols-2">
							<li>
								· 분장의 종이빛(Paper) 위에 그림자(Ink) 텍스트,
								조명색 Amber 한 방울로 시선 유도
							</li>
							<li>
								· 텍스트는 무겁고 크게, 여백은 넉넉하게 —
								포스터의 문법
							</li>
							<li>
							...
							<li>
								· 모든 헤드라인은 국문+영문 병기 — 세계인 소구의
								시각적 약속
							</li>
							<li>
								· 정지컷보다 GIF·루프·마퀴 등 ‘계속 움직이는’
								표현 우선
							</li>
						</ul>
					</div>
				...
				<Container>
						...
						<div className="space-y-4">
							<div className="rounded-xl border border-ink/12 bg-card p-5">
								...
								<p className="mt-2 text-sm text-ink/70">
									말풍선(대화)과 마임 분장 얼굴의 결합. 말풍선
									안은 비워 두고, 뜬 눈 하나와 그려진 눈물이
									‘말 없이 건네는 말’을 상징한다. 단색·1도
									인쇄, 최소 16px까지 판독 가능하도록 설계.
								</p>
							</div>
							<div className="rounded-xl border border-ink/12 bg-card p-5">
								<h3 className="font-bold text-amber">
					...
					<div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
						{COLORS.map((c) => (
							<div
								key={c.name}
								className="rounded-xl border border-ink/12 bg-base p-3"
							>
								<div
								...
								<p className="font-display text-xs text-ink/45">
									{c.hex.toUpperCase()}
								</p>
					...
					<div className="mt-5 grid gap-4 md:grid-cols-2">
						<div className="rounded-xl border border-ink/12 bg-base p-6">
							...
							<p className="mt-2 text-sm text-ink/60">
								국문 · <b className="text-ink">Noto Sans KR</b>{" "}
								— 본문 400/500, 헤드라인 900. 자간 -2%.
							</p>
						</div>
						<div className="rounded-xl border border-ink/12 bg-base p-6">
							...
							<p className="mt-2 text-sm text-ink/60">
								영문 디스플레이 ·{" "}
								<b className="text-ink">Anton</b> — 포스터
					...
					<div className="mt-5 grid gap-6 lg:grid-cols-[1fr_1.2fr]">
						...
						<div className="space-y-3 text-sm text-ink/75">
							<p>
								<b className="text-ink">설정</b> · 춘천 의암호의
								물방울에서 태어난 몸짓요정. 말은 못 하지만
								표정과 손짓으로 누구와도 대화한다.
							</p>
							<p>
								<b className="text-ink">식별 요소</b> · 하얀
								분장 얼굴 · 물방울 베레(Lake Blue) · 코랄
								스트라이프 셔츠 · 하얀 장갑.
							</p>
							<p>
								<b className="text-ink">역할</b> · 축제의
								안내자. 프로그램표에서 길을 알려 주고, 앱
								알림·스티커·거리 포토존에 등장.
							</p>
							<p>
								<b className="text-ink">보이스</b> · 말풍선은
								항상 그림/기호로만 채운다(느낌표, 하트, 발자국).
								절대 문장을 넣지 않는다.
							</p>
						</div>
					</div>
					...
					<p className="mt-3 max-w-2xl text-sm text-ink/70">
						...
						— <b className="text-ink">몸짓하는 검은 실루엣</b>, 네온
						옐로 타이포, 물·불의 난장 이미지 — 를 이어받아 ‘침묵으로
						세계와 통한다’는 북마크 캠페인 메시지에 맞게 확장한
						것입니다. (아래 이미지는 참고용 공식 홍보물이며 저작권은
						춘천마임축제에 있습니다.)
					</p>
					<div className="mt-5 grid gap-4 sm:grid-cols-3">
						<Figure
							photo={photos.keyVisual}
							aspect="aspect-[3/4]"
				...
				<Container>
					...
					<div className="mt-10 grid gap-4 md:grid-cols-3">
						{[
							[
								"허브",
								"웹 + PWA(앱) 단일 링크. D-day·프로그램표·오시는 길·공유·홈 화면 추가를 한 페이지에.",
							],
							[
								"확산",
								"‘저장하기 → 공유하기’ 2버튼 구조. SNS 카드·QR·잠금화면 배경 다운로드 제공.",
							],
							[
								"리텐션",
								"저장 사용자에게 D-30/D-7/개막일 웹푸시 알림, 종료 후 ‘내년 알림 예약’.",
							],
							[
								"글로벌",
								"국·영문 병기, 외국인용 접근성(교통·무료 프로그램) 우선 노출.",
							],
							[
								"현장 연계",
								"포스터·티켓·거리 배너의 QR → 동일 링크. 온·오프라인 접점 통합.",
							],
							[
								"측정",
								"저장수·공유수·설치수·푸시 허용률·예매 전환을 핵심 지표(KPI)로.",
							],
						].map(([t, d]) => (
							<div
								key={t}
