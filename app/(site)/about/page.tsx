...
const HISTORY = [
	{
		year: "1989",
		text: "‘한국마임페스티발’로 출발. 마임이스트들의 자발적 무대.",
	},
	{
		year: "1995",
		text: "춘천으로 자리를 옮기며 ‘춘천마임축제’로 개칭, 지역 축제로 성장.",
	},
	{
		year: "2000년대",
		text: "‘미친금요일’·‘아수라장’ 등 참여형 난장 프로그램 정착. 관객이 무대에 오르다.",
	},
	{
		year: "2010년대",
		text: "세계 3대 마임축제로 소개되며 해외 극단 초청 확대.",
	},
	{
		year: "2026",
		text: `${festival.editionKo} — ‘말 없이, 세계와 통하다’. 온라인 북마크 캠페인으로 세계인 초대.`,
	},
];
						...
						{[
							{
								icon: IconHands,
								t: "보이지 않는 것을 보이게",
								d: "벽, 상자, 바람, 밧줄 — 없는 것을 몸으로 그려 관객의 상상 속에 세웁니다.",
							},
							{
								icon: IconMask,
								t: "얼굴이 곧 대사",
								d: "하얀 분장은 표정을 극대화하는 장치. 눈썹 하나로 한 문장을 말합니다.",
							},
							{
								icon: IconSpotlight,
								t: "무대가 어디든",
								d: "조명 한 대와 배우 한 명이면 골목도 광장도 무대가 됩니다.",
							},
							{
								icon: IconStar,
								t: "관객이 완성한다",
								d: "웃음과 침묵, 참여가 없으면 장면은 완성되지 않습니다.",
							},
						].map(({ icon: Icon, t, d }) => (
							<div
								key={t}
								className="reveal flex gap-4 rounded-2xl border border-ink/12 bg-card p-6"
							>
			...
			<section className="border-y border-ink/10 bg-card/70 py-20">
				<Container>
					<SectionHeading
						kicker="History"
						title="1989 → 2026"
						desc="자발적 마임 무대에서 세계인의 축제로."
					/>
					<ol className="mt-12 space-y-0">
						{HISTORY.map((h, i) => (
							<li
								key={h.year}
								className="reveal grid grid-cols-[5.5rem_1fr] gap-5 border-l-2 border-ink/15 pb-8 pl-6 last:pb-0 sm:grid-cols-[7rem_1fr]"
							>
				...
				<Container>
					...
					<div className="mt-10 grid gap-6 md:grid-cols-3">
						{[
							[
								"국민 인지",
								"‘춘천 = 마임’ 연상률을 높이고, 비수도권 문화관광의 대표 사례로.",
							],
							[
								"세계 확장",
								"언어 장벽이 없는 콘텐츠 특성을 살려 해외 관객·관광객을 정면으로 겨냥.",
							],
							[
								"디지털 초대",
								"북마크·공유 가능한 링크 하나로 누구나 축제의 홍보대사가 되는 구조.",
							],
						].map(([t, d]) => (
							<div
								key={t}
								className="reveal rounded-2xl border border-amber/30 bg-card p-7"
							>
